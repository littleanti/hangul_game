...
export const VOWELS = [
  ...
  // shape: 'vertical' | 'horizontal' (세로형 / 가로형)
  ...
  { id: 'o',   char: 'ㅗ', sound: '오', shape: 'vertical',   order: 5 },
  { id: 'yo',  char: 'ㅛ', sound: '요', shape: 'vertical',   order: 6 },
  { id: 'u',   char: 'ㅜ', sound: '우', shape: 'vertical',   order: 7 },
  { id: 'yu',  char: 'ㅠ', sound: '유', shape: 'vertical',   order: 8 },
  { id: 'eu',  char: 'ㅡ', sound: '으', shape: 'vertical',   order: 9 },
  { id: 'i',   char: 'ㅣ', sound: '이', shape: 'horizontal', order: 10 },
];
...
| 이벤트 | 즉시 | 지연 후 |
|---|---|---|
| 정답 탭 | 정답 애니메이션 + `playCorrect()` + TTS 반복 | 800ms 후 다음 문항 |
...
- 분류 통에 `role="region"` + `aria-label="세로형 모음 통"` / `"가로형 모음 통"`.
